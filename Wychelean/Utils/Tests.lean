...
def bitwise : Suite where
  ...
  tests := pure [
    ...
    check "UInt32.ofBytesBE #v[0x12, 0x34, 0x56, 0x78]" 0x12345678 (UInt32.ofBytesBE #v[0x12, 0x34, 0x56, 0x78]),
    check "UInt32.ofBytesBE #v[0, 0, 0, 0]" 0 (UInt32.ofBytesBE #v[0, 0, 0, 0]),
    check "UInt32.ofBytesBE #v[0xff, 0xff, 0xff, 0xff]" 0xffffffff (UInt32.ofBytesBE #v[0xff, 0xff, 0xff, 0xff]),
    check "UInt32.ofBytesBE #v[0xde, 0xad, 0xbe, 0xef]" 0xdeadbeef (UInt32.ofBytesBE #v[0xde, 0xad, 0xbe, 0xef]),
